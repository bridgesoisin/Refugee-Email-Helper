...
thread_text = st.text_area("Paste PREVIOUS EMAILS or thread (optional)", height=150, key="thread")

user_notes = st.text_area("Extra notes/keywords in ENGLISH (optional)", height=150, key="notes")
